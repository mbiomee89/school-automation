...
export function ReportCalendarPicker({
  value,
  onChange,
  open,
  onClose,
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-7 gap-0.5">
        {cells.map((cell) => {
          const selected = cell.dateOnly === value.slice(0, 10)
          ...
          return (
            <button
              ...
              className={cn(
                ...
                cell.inMonth && !selected && 'text-slate-800 hover:bg-slate-100 dark:text-slate-100 dark:hover:bg-slate-800',
