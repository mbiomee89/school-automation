import { Home, CalendarCheck, BookOpenCheck, Settings2, type LucideIcon } from 'lucide-react'
...
const TABS: TabDef[] = [
  ...
  // Notifications (WhatsApp log) hidden — messaging handled manually for now
